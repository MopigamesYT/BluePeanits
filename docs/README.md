  ...
  <p>
    ...
    <details>
      ...
      <ol>
        ...
        <li><strong>One-click install:</strong> Click this link to Install Blue Peanits directly: <a href="https://github.com/SwingTheVine/Wplace-BlueMarble/releases/download/vVersion/BlueMarble.user.js" target="_blank" rel="noopener noreferrer"><strong>Install Blue Peanits</strong></a>
        <br>
