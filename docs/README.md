<table>
  <tr>
    <td><a href="#blue-marble">Blue Peanits</a></td>
  ...
  <tr>
    <td>&emsp;&emsp;<a href="#is-blue-marble-malware">Is Blue Peanits malware?</a></td>
  </tr>
  <tr>
    <td>&emsp;&emsp;<a href="#how-can-blue-marble-place-pixels-for-me">How can Blue Peanits place pixels for me?</a></td>
  </tr>
  <tr>
...
<a href="" target="_blank" rel="noopener noreferrer"><img alt="Compression" src="https://img.shields.io/badge/Compression-63.11%25-blue"></a>
...
<p>
  ...
  <details>
    <summary>
      <b>I want to download Blue Peanits.</b> <sup>(Click to Expand)</sup>
    </summary>
    <a href="#installation-instructions">Click here</a> to view the installation instructions.
  </details>
  <details>
    <summary>
      <b>I want to ask questions about Blue Peanits.</b> <sup>(Click to Expand)</sup>
    </summary>
    <a href="https://discord.gg/tpeBPy46hf" target="_blank" rel="noopener noreferrer">Click here</a> for the Discord server invite to the Blue Peanits support server.
    <br>
    <a href="https://github.com/SwingTheVine/Wplace-BlueMarble/discussions/categories/q-a">Click here</a> for the GitHub help & question page for Blue Peanits.
  </details>
  <details>
    <summary>
...
<h2>Overview</h2>
<p>
  Welcome to Blue Peanits! Blue Peanits is a userscript for the website <a href="https://wplace.live/" target="_blank" rel="noopener noreferrer">wplace.live</a>. The purpose of Blue Peanits is to allow you to take an image, and layer it onto the canvas! That way, you can easily trace the image of your art, without having to look back and forth between multiple tabs/monitors. In addition, Blue Peanits supports some neat extra features such as: 
  <ul>
  ...
  If you like this userscript, please ⭐ the repository! If you wish to contribute to Blue Peanits, check out the <a href="https://github.com/SwingTheVine/Wplace-BlueMarble/blob/main/docs/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer">CONTRIBUTING.md</a> file in <code>docs/</code>.

  <img alt="Showcase image of Blue Peanits template" src="./assets/Showcase1.png">
  ...
  <p>
    Blue Peanits has been verified to work on mobile devices. Blue Peanits was designed on Chrome, but Blue Peanits might work on "unsupported" browsers not listed above. Some versions/forks of Firefox work. Some versions/forks of Firefox do not work.
    <br>
    Installation instructions for Blue Peanits are below. Click the arrows to expand the instructions you want to see. Blue text is a link.
    <details>
      <summary>
      ...
      <ol>
        ...
        <li><strong>One-click install:</strong> Click this link to Install Blue Peanits directly: <a href="https://github.com/SwingTheVine/Wplace-BlueMarble/releases/download/pre/BlueMarble.user.js" target="_blank" rel="noopener noreferrer"><strong>Install Blue Peanits</strong></a>
        <br>
    ...
    <details>
      ...
      <ol>
        ...
        <li>Click the "Install" button to Install Blue Peanits.
        <br>
        ...
        <li>Enable Blue Peanits inside the TamperMonkey dashboard.
        <br>
        <img alt="Enable Blue Peanits" src="https://github.com/SwingTheVine/Wplace-BlueMarble/blob/main/docs/assets/ComputerChromeInstall7.png"></li>
        <li>Refresh the <a href="https://wplace.live/" target="_blank" rel="noopener noreferrer">wplace.live</a> webpage.</li>
      </ol>
    </details>
    <details>
  ...
  <p>
    Blue Peanits will display your template as the same size. If your image is 500 pixels tall and 300 pixels wide, the template will be 500 pixels tall and 300 pixels wide. Here is the instructions to display a template image on the canvas:
    <ol>
  ...
  <p>
    There are many settings available for the Blue Peanits userscript! Through these settings, you can control how the script behaves.
    <!--
    <h4>Stealth Mode</h4>
    <a href="" target="_blank"><img alt="Default: Enabled" src="https://img.shields.io/badge/Default-Enabled-lightgreen?style=flat"></a>
    <p>
      Stealth Mode, when enabled, requires the game to make a request to the server instead of Blue Peanits making its own requests. However, this means Blue Peanits will wait indefinitely until the request is made. <b>This should be used with Possessed Mode</b> so Blue Peanits can "suggest" the game make certain requests instead of waiting for the requests to naturally occur.
    </p>
    <h4>Possessed Mode</h4>
    <a href="" target="_blank"><img alt="Default: Enabled" src="https://img.shields.io/badge/Default-Enabled-lightgreen?style=flat"></a>
    <p>
      In Possessed Mode, Blue Peanits will prioritize controling the game over directly interacting with the server. For example, assume a situation where Blue Peanits is trying to place a pixel. However, the tile is not loaded. Typically, Blue Peanits would make a request to the server to fetch the tile. When <b>Possessed Mode</b> is enabled, Blue Peanits will teleport the game to the tile, which causes the game to fetch the tile. The difference lies in <i>who</i> sends the request to the server. When <b>Stealth Mode</b> and <b>Possessed Mode</b> are both enabled, it is harder to detect the userscript since most actions are made through the game, not the userscript.
    </p>
    -->
  </p>
...
<h2>Licenses</h2>
<p>
  (Below, all mentions of the "userscript" refer to the "Blue Peanits" userscript made by SwingTheVine) <br>
  Most of this userscript is licensed under the <code>Mozilla Public License Version 2.0</code> (MPL-2.0). All software, code, and libraries in this repository are licensed under the MPL-2.0 license. However, the "Blue Peanits" image in this userscript is owned by NASA and is licensed under the <code>Creative Commons 0 1.0 Universal</code> (CC0 1.0) license.
</p>

<h2>FAQ</h2>
<p>
  <h3>Is Blue Peanits malware?</h3>
  <p><b>A:</b> Blue Peanits does not contain malicious code. The Blue Peanits code can be found in the <code>src/</code> folder. If you worry about Blue Peanits being malware, you can read the code, then bundle it yourself using the tools in <code>build/</code>.

  <h3>How can Blue Peanits place pixels for me?</h3>
  <p><b>A:</b> Unfortunatly, Blue Peanits will not support the automatic placement of pixels without user interaction.
